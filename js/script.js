...
const prevButton = document.querySelector('.prev-new');
const nextButton = document.querySelector('.next-new');
...
function goToSlide(index) {
    ...
    document.querySelector('.slider-track-new').style.transform = `translateX(${offset}%)`;
}
